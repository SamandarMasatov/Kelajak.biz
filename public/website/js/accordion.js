...
settings.addEventListener('click', () => {
	speed.classList.toggle('activ-speed')
	settings.classList.toggle('rotate-setting')
})

//ELEMENT SELECTORS 
// var accordionVideoItem = document.querySelector('.accordion-video-item');
...
function setSpeed(e) {
	...
	speedBtns.forEach(speedBtn => speedBtn.classList.remove('activeli'));
...
// accordionVideoItem.addEventListener('click', accordionVideoClick);
